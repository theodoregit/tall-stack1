                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative rounded-md shadow-sm">
                            <input wire:model.defer="name" id="name" name="name" value="{{ old('name') }}"
                                class="@error('name')border border-red-500 @enderror form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150 rounded-md"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative rounded-md shadow-sm">
                            <input wire:model.defer="email" id="email" type="text" name="email" value="{{ old('email') }}"
                                class="@error('email')border border-red-500 @enderror rounded-md form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150"
                                placeholder="Email">
                        </div>
                        @error('email')
                        <p class="text-red-500 mt-1">{{ $message }}</p>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative rounded-md shadow-sm">
                            <input wire:model.defer="phone" id="phone" name="phone" value="{{ old('phone') }}"
                                class="@error('phone')border border-red-500 @enderror rounded-md form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150"
                                placeholder="Phone">
                        </div>
                        @error('phone')
                        <p class="text-red-500 mt-1">{{ $message }}</p>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative rounded-md shadow-sm">
                            <textarea wire:model.defer="message" id="message" rows="4" name="message"
                                class="@error('message')border border-red-500 @enderror rounded-md form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150"
